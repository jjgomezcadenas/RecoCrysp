...
\input{tbsrc/intro}
\input{tbsrc/geometry}
\input{tbsrc/grid}
\input{tbsrc/projection}
\input{tbsrc/resolution}
\input{tbsrc/datamodel}
\input{tbsrc/statistics}
\input{tbsrc/mlem}
\input{tbsrc/acceleration}
\input{tbsrc/pipeline}
\input{tbsrc/summary}

\appendix
\input{tbsrc/appendices}
