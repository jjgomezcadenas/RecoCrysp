# Julia/KernelAbstractions port of the non-TOF Joseph 3D matched forward and back
# projectors from libparallelproj (KUL-recon-lab, Apache-2.0):
#   src/joseph3d_fwd_worker.h, src/joseph3d_back_worker.h, include/utils.h
#
# A single kernel source runs on CPU threads, Apple Metal, CUDA, ... via
# KernelAbstractions. All arithmetic is Float32 (Metal has no Float64).
#
